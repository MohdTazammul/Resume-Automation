        ...
        <tbody>
          ...
          <tr className="c29">
            ...
            <td className="c45" colSpan={1} rowSpan={1}>
              <p className="c36">
                <span className="c17 c18">EDUCATION</span>
              </p>
              <p className="c16">
                <span className="c14"></span>
              </p>
              ...
              <h1 className="c38" id="h.a9l5z4y9rnz4">
              ...
              <h1 className="c38" id="h.lmqf9yx68b7c">
              ...
              <h1 className="c37" id="h.tuxh7mwdaxox">
              ...
              <p className="c20">
                ...
                <span>
                  Patent on Project - &nbsp;Retro fitment kit for Auto Rickshaw
                  to convert IC engine to Electric engine, June 2021
                </span>
              </p>
              <p className="c20">
              ...
              <h1 className="c37" id="h.59kk2i3ikr6k">
                <span>INTERESTS</span>
              </h1>
              <p className="c28">
